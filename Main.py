...
for comment in subreddit.stream.comments(skip_existing=True):
    try:
        ...
        if((re.search('/u/botofmanynames',comment.body,re.IGNORECASE) or re.search('u/botofmanynames',comment.body,re.IGNORECASE))): #Make sure we're tagged in order to run. Non caps-sensitive.
